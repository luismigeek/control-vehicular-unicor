...
class estudiantes extends Controller
{
	...
	function render()
	{
		...
		if (isset($_SESSION['ROL'])) {
			if ($_SESSION['ROL'] != 'estudiante') {
				...
				$this->view->usuario = '[Estudiante] ' . $_SESSION['USUARIO'];
			}
		} else {
	...
	public function register()
	{
		...
		$this->view->render('estudiantes/register');
	}
	...
	public function myvehicles()
	{
		...
		$this->view->render('estudiantes/myvehicles');
	}
	...
	public function details($data = null)
	{
		...
		$this->view->render('estudiantes/details');
	}
