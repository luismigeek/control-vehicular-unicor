...
<div class="container-fluid">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"> Matricula del vehiculo que sale</div>
      <div class="card-body">
        <form id="salidaVeh" method="POST">
          ...
          <a class="btn btn-primary btn-block" id="btn_salidaVeh" href="#">Guardar</a>
        </form>
        <div class="text-center mt-3" id="msg_salidaVeh">
        </div>
      </div>
    </div>
  </div>
