    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo constant('URL'); ?>vigilantes/entry">Entrada</a>
          <a class="dropdown-item" href="<?php echo constant('URL'); ?>vigilantes/moveon">Salida</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo constant('URL'); ?>vigilantes/vehiclesincampus">Vehiculos sin salir</a>
        </div>
      </li>
    </ul>
