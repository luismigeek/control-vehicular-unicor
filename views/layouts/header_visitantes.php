...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <!--a class="nav-link" href="<?php echo constant('URL'); ?>visitantes/misdatos"-->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="<?php echo constant('URL'); ?>visitantes/register">Registrar vehiculo</a>
          <a class="dropdown-item" href="<?php echo constant('URL'); ?>visitantes/myvehicles">Listar vehiculos</a>
        </div>
      </li>
    </ul>
